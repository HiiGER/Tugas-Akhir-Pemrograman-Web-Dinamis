...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Absen -->
            <li class="nav-item">
                <a class="nav-link" href="Present.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Absensi</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseEmployee" class="collapse" aria-labelledby="headingEmployee" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="MActivity.php">Medicin list</a>
                        <a class="collapse-item" href="CActivity.php">Cashier list</a>
                        <a class="collapse-item" href="Present.php">Present</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Hi <?php echo htmlspecialchars($name); ?> Here Your Manage Report</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Prndapatan (Bulanan)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. 4000.000</div>
                                        </div>
                                        <div class="col-auto">
